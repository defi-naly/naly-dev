...
import { createNoise2D, createNoise3D, fbm } from '../../lib/noise';
...
export function ParaglidingMachine({ progress }: { progress: number }) {
  ...
  const projectGeos = useMemo(() => [
    new THREE.EdgesGeometry(new THREE.LatheGeometry(
    ...
    createEnneperGeometry(0.3),
    createKleinBottleGeometry(0.3),
    createMobiusGeometry(0.3),
  ], []);
