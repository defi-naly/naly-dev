...
const CRISES = [
  {
    ...
    assets: {
      gold: {
        ...
        '3y': { return: 69, note: 'Fixed at $35' },
        '5y': { return: 69, note: 'Fixed at $35' },
      },
      stocks: {
        '1y': { return: 5, note: 'Stabilizing' },
        '3y': { return: 80, note: 'Recovery rally' },
        '5y': { return: 50, note: '1937 crash hit' },
      },
      bonds: {
        '1y': { return: 10, note: 'Safe haven' },
        '3y': { return: 22, note: 'Yields falling' },
        '5y': { return: 28, note: 'Steady gains' },
      },
      cash: {
        '1y': { return: -40, note: 'Gold devaluation' },
        '3y': { return: -38, note: 'Mild deflation' },
        '5y': { return: -35, note: 'Prices stabilized' },
      },
    },
    takeaway: 'Hard assets won. Cash holders lost 40% vs gold overnight.',
  },
  {
    id: '1940s',
    year: '1940s',
    ...
    assets: {
      gold: {
        '1y': { return: 0, note: 'Fixed $35 (nominal)' },
        '3y': { return: 0, note: 'Fixed $35 (nominal)' },
        '5y': { return: 0, note: 'Losing to inflation' },
      },
      stocks: {
        '1y': { return: 8, note: 'Post-war growth' },
        '3y': { return: 28, note: 'Growing' },
        '5y': { return: 55, note: '+20% real' },
      },
      bonds: {
        '1y': { return: 2, note: 'Nominal gain' },
        '3y': { return: -4, note: 'Real loss' },
        '5y': { return: -12, note: 'Repression' },
      },
      cash: {
        '1y': { return: -8, note: 'Inflation 8%+' },
        '3y': { return: -18, note: 'Eroding' },
        '5y': { return: -28, note: 'Real terms' },
      },
    },
  ...
  },
  {
    ...
    assets: {
      gold: {
        '1y': { return: 85, note: '$35 → $65' },
        '3y': { return: 240, note: '$35 → $120' },
        '5y': { return: 257, note: '$35 → $125' },
      },
      stocks: {
        '1y': { return: 5, note: 'Sideways' },
        '3y': { return: -30, note: '73-74 crash' },
        '5y': { return: 10, note: 'Flat nominal' },
      },
      bonds: {
        '1y': { return: 3, note: 'Nominal' },
        '3y': { return: -8, note: 'Real loss' },
        '5y': { return: -18, note: 'Real terms' },
      },
      cash: {
        '1y': { return: -5, note: 'Weakening' },
        '3y': { return: -18, note: 'Inflation' },
        '5y': { return: -32, note: 'Real terms' },
      },
    },
  ...
  },
  {
    ...
    assets: {
      gold: {
        ...
        '3y': { return: 100, note: 'Peak 2011' },
        '5y': { return: 45, note: 'Pulled back' },
      },
      stocks: {
        '1y': { return: -38, note: 'Crash' },
        '3y': { return: 48, note: 'Recovery' },
        '5y': { return: 125, note: 'Bull run' },
      },
      bonds: {
        '1y': { return: 12, note: 'Flight to safety' },
        '3y': { return: 22, note: 'QE boost' },
        '5y': { return: 30, note: 'QE boost' },
      },
      cash: {
        '1y': { return: 0, note: 'No inflation' },
        '3y': { return: -4, note: 'Slow erosion' },
        '5y': { return: -8, note: 'Real terms' },
      },
      bitcoin: {
