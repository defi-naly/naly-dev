...
**The paradox**: The smarter you are, the more vulnerable you are to falling in love with your own ideas—and the harder it is to let them go.
...
```
         CONFIDENCE IN ABILITY
              HIGH │ LOW
    ────────────────┼────────────────
    HIGH │ Armchair  │ Imposter
CONFIDENCE    quarterback  syndrome
IN BELIEFS    (arrogant)  (paralyzed)
    ────────────────┼────────────────
    LOW  │ Confident │ Self-doubting
         │ humility  │ and ineffective
         │ (optimal) │
```
...
|----------|--------------|
| More facts | Backfire effect—they dig in |
