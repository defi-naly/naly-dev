...
┌─────────────────────────────────────────────────────────┐
│  1. DIAGNOSIS                                           │
│     What's going on? What's the challenge?              │
├─────────────────────────────────────────────────────────┤
│  2. GUIDING POLICY                                      │
│     Overall approach to overcome the obstacle           │
├─────────────────────────────────────────────────────────┤
│  3. COHERENT ACTIONS                                    │
│     Coordinated steps that carry out the policy         │
└─────────────────────────────────────────────────────────┘
```

**Strategy is NOT goals, ambition, or vision. Strategy is a coherent response to a challenge.**
...
1. **List the most important challenges** facing the organization
2. **Prioritize** - which is the crux?
3. **Diagnose** - what's causing this?
4. **Generate options** - what are possible guiding policies?
5. **Evaluate** - which approach best leverages our strengths against the challenge?
6. **Define coherent actions** - what specific steps carry out the policy?
