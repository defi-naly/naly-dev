...
/**
 * Single fixed Canvas covering the viewport.
 * Machines have overlapping ranges so crossfades happen naturally:
 * the outgoing machine's dissolve overlaps with the incoming machine's fade-in.
 * No separate transition components needed.
 */
